...
def about():
    ...
    if request.method == "POST":
        ...
        return render_template("about.html", sites = sites, description=site)
    return render_template("about.html", sites = sites, description="")

@app.route("/showfirstrecord", methods=['get'])
def showfirstrecord():
    record = records.find_one()
    return render_template('record.html', record = record)
    
    
@app.route("/showrecord/<name>")
def showrecord(name):
